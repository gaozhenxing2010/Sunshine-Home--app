...
CREATE TABLE xz_news(
  ...
  pis VARCHAR(255),
  money VARCHAR(255),   #钱
  integral VARCHAR(255), #积分
  coupons VARCHAR(150) #优惠券

  
  
);
INSERT INTO xz_news VALUES(1,'张玲',now(),1,
"http://127.0.0.1:3000/img/pic.png","..","60","0.64","1000","500","5");
INSERT INTO xz_news VALUES(2,'张玲',now(),0,
"http://127.0.0.1:3000/img/pic.png","..","60","0.64","1000","500","5");
INSERT INTO xz_news VALUES(3,'张玲',now(),0,
"http://127.0.0.1:3000/img/pic.png","..","60","0.64","1000","500","5");
INSERT INTO xz_news VALUES(4,'张玲',now(),0,
"http://127.0.0.1:3000/img/pic.png","..","60","0.64","1000","500","5");
INSERT INTO xz_news VALUES(5,'张玲',now(),0,
"http://127.0.0.1:3000/img/pic.png","..","60","0.64","1000","500","5");
INSERT INTO xz_news VALUES(6,'张玲',now(),0,
"http://127.0.0.1:3000/img/pic.png","..","60","0.64","1000","500","5");
INSERT INTO xz_news VALUES(7,'张玲',now(),0,
"http://127.0.0.1:3000/img/pic.png","..","60","0.64","1000","500","5");
INSERT INTO xz_news VALUES(8,'张玲',now(),0,
"http://127.0.0.1:3000/img/pic.png","..","60","0.64","1000","500","5");
